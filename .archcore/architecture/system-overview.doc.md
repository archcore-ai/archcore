...
|---|---|---|
| CLI | ten commands registered at @cli/cmd/root.go | `cli-ui/building-the-cli.doc` |
...
opaque `BackgroundTask func(context.Context)` — @cli/internal/mcp/server.go — so the server never links
