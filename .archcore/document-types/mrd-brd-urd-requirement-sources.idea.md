...
Status: implemented. All three types ship in `@cli/templates/templates.go` and are documented in the categories-and-document-types reference.
...
- Existing PRD template in @cli/templates/templates.go
- MCP server instructions in @cli/internal/mcp/server.go
