...
- `@cli/internal/mcp/tools/add_relation.go` — layer hints in the tool description
- `@cli/internal/mcp/server.go` — REQUIREMENTS LAYERS instructions
- `@cli/templates/templates.go` — ISO template traceability sections
