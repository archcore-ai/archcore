...
- `@cli/templates/templates.go` — type constant, category mapping, template function
- `@cli/internal/mcp/server.go` — MCP server instructions with disambiguation rules
- `@cli/internal/mcp/tools/create_document.go` — MCP tool description with the type entry
