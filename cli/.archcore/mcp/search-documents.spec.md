...
- Implementation: @internal/mcp/tools/search_documents.go, @internal/mcp/tools/response_budget.go
- Tool registration: @internal/mcp/server.go
- Tests: @internal/mcp/tools/search_documents_test.go, @internal/mcp/tools/search_recall_test.go, @internal/mcp/tools/response_budget_test.go
...
- The recorded unit tests in @internal/mcp/tools/search_documents_test.go, @internal/mcp/tools/search_recall_test.go, and @internal/mcp/tools/response_budget_test.go (these tests are the executable acceptance harness for this spec).
